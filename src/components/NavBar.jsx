...
import logoStarWars from '../assets/logoStarsWar.png'
...
const NavBar = () => {
  ...
  return (
    <nav className='w-full bg-gray-900 opacity-90'>
      {/* vista de escritorio*/}
      <div className='flex items-center justify-between sm:px-12 sm:py-6 px-6 py-3'>
        <div className='flex items-center gap-2'>
          <img src={logoStarWars} alt='sol de mayo' className= 'w-[60px]'/>
        </div>
        ...
        <div className='hidden md:block'>
          <ul className='flex space-x-4 px-4'>
            {navBarLinks.map(link => 
              // cuando no hay lógica se usa return implicito, 
              // solo parentesis sin la palabra return
              // y sin llaves
              (
                <li key={link.id}>
